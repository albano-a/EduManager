...
import com.albano.edumanager.Nota;
...
public class NotaDAO {
    ...
    private static Nota mapearResultSetParaNota(ResultSet rs) throws SQLException {
        ...
        // Montar aluno e disciplina (simplificado)
        Aluno aluno = new Aluno(rs.getInt("id_aluno"), rs.getString("aluno_nome"), new java.util.Date(), null);
